      ...
      <div className="mx-auto max-w-7xl">
        <div className="space-y-2 text-black">
          ...
          <section className="p-10">
            ...
            <p className="py-2">Personal Data</p>
            <p className="py-2">
            ...
            <p className="py-2 font-semibold">Usage Data</p>
            <p>
            ...
            <p className="py-2 font-semibold">Tracking & Cookies Data</p>
            <p>
            ...
            <p className="py-2">Examples of Cookies we use:</p>
            <li>
            ...
            <p className="py-2 font-semibold">Transfer Of Data</p>
            <p className="py-2">
            ...
            <li>
              To protect and defend the rights or property of [Insert your
              company/website]
            </li>
            <li>
            ...
            <p className="py-2 font-semibold">Security of Data</p>
            <p className="py-2">
            ...
            <p className="py-2 font-semibold">Service Providers</p>
            <p className="py-2">
            ...
            <p className="py-2 font-semibold">Analytics</p>
            <p className="py-2">
            ...
            <p className="py-2 font-semibold">Children's Privacy</p>
            <p className="py-2">
